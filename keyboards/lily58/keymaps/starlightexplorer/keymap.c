...
[_CONTROL] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______,                   KC_HOME, XXXXXXX, KC_PGUP, KC_BRMD,   KC_BRMU, _______, \
  _______, _______, _______, _______, _______, _______,                   KC_END,  KC_UP,   KC_PGDN, KC_VOLDOWN,KC_VOLUP,_______, \
